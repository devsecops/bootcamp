...
##### After finishing your MVP and you move to the next stage of development, do you build on the already existing MVP or develop from the "ground up" using what you learned from the building of the MVP?