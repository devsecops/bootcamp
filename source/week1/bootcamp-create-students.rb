...
# You must run the following commands to have run this script:
# export AWS_SECRET_ACCESS_KEY=28ckx6PTVLotGQAHtLlqI0+4zvZDrlyrA+kdePX3
# export AWS_ACCESS_KEY_ID=AKIAJ2K5AWCQ3E6TSZYA
#
